...
- AgentFormPanel.tsx: 35+ var(--*), imports ConfirmActionDialog — update import to @openclaw/ui (already exported in Phase 2)
...
- board-groups/page.tsx imports ConfirmActionDialog from @/components/ui/ — update to @openclaw/ui
...
### Reusable Assets
- @openclaw/ui: Button, Badge, Modal, Select, TextField, TextArea, cx, ConfirmActionDialog (added Phase 2)
- @openclaw/ui patterns: SidePanel, FilterBar, StatusBadge, PageHeader, OCEmptyState
...
### Integration Points
- ConfirmActionDialog: AgentFormPanel and board-groups/page.tsx need import path updated to @openclaw/ui

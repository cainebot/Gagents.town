...
import type { CardType, CustomFieldType } from '@/types/workflow'
...
// GET /api/workflows/[id]/fields — return custom field definitions for a workflow
...
// POST /api/workflows/[id]/fields — create a new custom field definition
...
export async function POST(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    const e = err as Error & { code?: string; details?: string; hint?: string }
    if (e.code === '23505') {
      return errorResponse(409, 'A field with this name already exists for this workflow and card_type', undefined, undefined, 'CONFLICT')
    }
    return errorResponse(500, e.message, e.details, e.hint, e.code)
  }
}

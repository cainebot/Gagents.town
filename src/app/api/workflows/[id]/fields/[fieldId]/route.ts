...
import type { CustomFieldType } from '@/types/workflow'
...
// PATCH /api/workflows/[id]/fields/[fieldId] — update a field definition
...
// DELETE /api/workflows/[id]/fields/[fieldId] — delete a field definition

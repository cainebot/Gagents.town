/**
 * Bridges game events from React/HUD into the Phaser scene.
 * Extracted from Agent Town: components/game/systems/SceneEventBridge.ts
 *
 * NOTE: In our setup, Supabase Realtime hooks will emit into gameEvents
 * (via Plan 05). This bridge receives those events and applies them to
 * the Phaser scene workers.
 */

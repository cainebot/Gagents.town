/**
 * Handles player-worker proximity detection and interaction menus.
 * Extracted from Agent Town: components/game/systems/InteractionManager.ts
 */
...
import { INTERACT_DISTANCE, PRESS_E_STYLE, PROMPT_Y_OFFSET } from "../constants";

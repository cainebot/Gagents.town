/**
 * Constants extracted from Agent Town for the Office 2D Phaser scene.
 * Original: lib/constants.ts
 *
 * NOTE: Agent Town-specific constants (persistence keys, chat, gateway)
 * are intentionally omitted. We use Supabase Realtime instead.
 */

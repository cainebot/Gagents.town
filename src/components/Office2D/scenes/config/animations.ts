 ...
 * Extracted from Agent Town: components/game/config/animations.ts
 *
 * All Premade_Character_48x48_XX.png sheets share the same layout:
 *   48x96 frames, 56 cols x ~20 rows
...
// Boss character (player-controlled)
export const BOSS_SPRITE_KEY = "character_09";
export const BOSS_SPRITE_PATH = "/assets/characters/Premade_Character_48x48_09.png";

// Legacy exports for Player.ts compatibility
...
export const WORKER_SPRITES: WorkerSpriteConfig[] = [
  { key: "character_02", path: "/assets/characters/Premade_Character_48x48_02.png", label: "Alice" },
  { key: "character_03", path: "/assets/characters/Premade_Character_48x48_03.png", label: "Bob" },
  { key: "character_04", path: "/assets/characters/Premade_Character_48x48_04.png", label: "Carol" },
  { key: "character_05", path: "/assets/characters/Premade_Character_48x48_05.png", label: "Dave" },
];

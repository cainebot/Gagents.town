        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: '20px 0 12px 0' }}>
          <div
            style={{
              ...
              height: '80px',
              borderRadius: '50%',
              background: previewIsPhoto ? 'var(--surface)' : selectedColor,
              display: 'flex',
              alignItems: 'center',
                ...
                {EMOJI_GRID.map((em) => (
                  <button
                    ...
                    style={{
                      ...
                      border: selectedEmoji === em ? '2px solid var(--accent)' : '2px solid transparent',
                      borderRadius: '8px',
                      cursor: 'pointer',
                      padding: 0,
                    }}
            ...
            <>
              ...
              <div
                ...
                style={{
                  ...
                  gap: '8px',
                  cursor: 'pointer',
                  background: dragOver ? 'rgba(255,59,48,0.05)' : 'var(--surface)',
